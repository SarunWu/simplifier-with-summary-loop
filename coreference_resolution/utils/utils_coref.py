# please refer to below original source
...
predictor = Predictor.from_path(model_url, cuda_device=0)
...
class IntersectionStrategy(ABC):
    ...
    def __init__(self, allen_model=model_url, hugging_model=neuralcoref.add_to_pipe(nlp)):
        self.allen_clusters = []
    ...
    def acquire_models_clusters(self, text: str):
        ...
        allen_prediction = predictor.predict(document=text)
