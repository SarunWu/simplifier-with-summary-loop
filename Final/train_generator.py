...
models_folder = "/home/jacky/research_boost/main/gpt2m/models"
logs_folder =   "/home/jacky/research_boost/main/gpt2m/logs"
...
for _ in range(n_epochs):
    for ib, batch in enumerate(dl_train):
        ...
        if time.time()-time_save > 60.0:
            ...
            time_save = time.time()
            model_output_file = os.path.join(models_folder, "gpt2m_"+args.experiment+".bin")
